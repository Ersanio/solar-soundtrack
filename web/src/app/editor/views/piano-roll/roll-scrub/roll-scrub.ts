...
import type { ScrubBar } from '../roll-marks';
import { KEY_WIDTH, SCRUB_HEIGHT } from '../roll-metrics';
import { scrubTick } from '../roll-layout';
 ...
 * the roll's own scroller, because a scrubber that scrolled out of view would be
...
export class RollScrub {
  ...
  readonly bars = input.required<readonly ScrubBar[]>();
